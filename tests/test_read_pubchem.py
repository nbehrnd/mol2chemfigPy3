...
-[::90]O-[::300]H)(<[::270]H)-[::0](-[::37.5]H)(-[::82.5]H)-[::300]N-[::60]%
...
-[::300]\phantom{N})=^[::60]N-[::60](=[::300]O)-[::60]N(-[::300]H)-[::60](%
-[::60])=[::300]O}"""
target6 = r"""\chemfig{O=[:93]-[::45]N-[::270](-[::72]S-[::72](-[::348](-[::300]H)(%
-[::0]H)-[::50]H)(-[::264](-[::60]H)(-[::0]H)-[::300]H)-[::72](-[::348](%
=[::60]O)-[::300]O-[::60]H)(<:[::284]H)-[::72]\phantom{N})(<[::351]H)%
-[::270](-[::270])(<[::90]H)-[::0]N(-[::300]H)-[::60](=[::60]O)-[::300](%
-[::277.5]H)(-[::322.5]H)-[::60]-[::60](-[::60]H)(%
-[::240,,,,draw=none]\mcfcringle{1.3})-[::300](-[::60]H)-[::300](-[::60]H)%
-[::300](-[::60]H)-[::300](-[::300])-[::60]H}"""
